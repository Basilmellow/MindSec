...
const PLANS: PricingPlan[] = [
  {
    ...
    wasPrice: '$299',
    savings: 'SAVE 50%',
    description: 'A focused external review for a small public website, domain perimeter, or launch-ready web app.',
    scopeEndpoints: '1 Domain / Perimeter Scope',
    allocatedHours: '12-16 Testing Hours',
    pipsCount: 3,
    features: [
      'External attack-surface & DNS review',
      'Security headers & TLS configuration audit',
  ...
  },
  {
    ...
    savings: 'SAVE $300',
    featured: true,
    description: 'Deep manual security testing for a web application with defined authentication and user roles.',
    scopeEndpoints: '1 Auth Role / Up to 15 Views',
    allocatedHours: '30-40 Testing Hours',
    pipsCount: 7,
    features: [
      'OWASP Top 10 manual deep testing',
      'Authentication & Password Reset flaw checks',
      'Broken Object Level Authorization (BOLA / IDOR)',
      'Business-logic & race condition validation',
      'Client-side execution (XSS, CSRF, DOM leaks)',
      'Actionable remediation code snippets included',
    ],
  },
  {
    id: 'api',
    ...
    allocatedHours: '25-35 Testing Hours',
    pipsCount: 5,
    features: [
      'Endpoint authorization & BOLA/IDOR testing',
      'JWT signature & OAuth 2.0 token checks',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 border border-border-color rounded-lg bg-bg-surface overflow-hidden">
            ...
            <div className="lg:col-span-7 p-6 space-y-4 border-b lg:border-b-0 lg:border-r border-border-color">
              <span className="font-mono text-[10px] text-text-muted tracking-widest uppercase">
                RESOURCE ALLOCATION: {activePlan.name}
              </span>
              ...
              <div className="space-y-3 font-mono text-xs">
                ...
                <div className="flex justify-between items-center border-b border-border-color pb-2">
                  <span className="text-text-secondary">TESTING CAPACITY</span>
                  <span className="text-text-primary font-bold">{activePlan.allocatedHours}</span>
                </div>
            ...
            <div className="lg:col-span-5 p-6 bg-bg-surface-2 flex flex-col justify-between space-y-4">
              <div className="space-y-1">
                ...
                <p className="font-mono text-[11px] text-text-secondary">STARTING FROM / PER ASSESSMENT</p>
              </div>

              <a href="#contact" className="btn-nw btn-nw-solid justify-center">
                <span>[ CONFIRM THIS SCOPE ]</span>
