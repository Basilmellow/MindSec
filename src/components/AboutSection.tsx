...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-24 bg-bg-canvas border-b border-bg-border relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="space-y-4">
          ...
          <blockquote className="text-xl sm:text-2xl text-secondary max-w-3xl font-light italic border-l-2 border-cyan-accent pl-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* Practice Principles */}
          <div className="lg:col-span-7 bg-bg-surface border border-bg-border rounded-xl p-8 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
          ...
          {/* Founder Card */}
          <div className="lg:col-span-5 bg-bg-card border border-bg-border rounded-xl p-8 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <span className="font-mono text-xs text-secondary tracking-widest uppercase">
                FOUNDED BY
              </span>
            ...
            <div className="pt-4 border-t border-bg-border text-[11px] font-mono text-secondary">
