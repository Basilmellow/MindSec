...
export const Section03Verify: React.FC = () => {
  return (
    <section id="verify" className="py-24 bg-bg-canvas border-b border-border-color relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <span className="eyebrow">VULNERABILITY PROOF & VERIFICATION</span>
          </div>
        ...
        <div className="bg-bg-surface border border-border-color rounded-xl p-6 sm:p-8 space-y-8 shadow-[0_15px_35px_rgba(0,0,0,0.3)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 font-mono text-xs">
            <div className="bg-bg-card p-4 rounded border border-border-color space-y-1">
              ...
              <p className="text-text-primary font-bold text-sm truncate">{SAMPLE_FINDING.title}</p>
            </div>
            <div className="bg-bg-card p-4 rounded border border-border-color space-y-1">
              <span className="text-text-muted">SEVERITY:</span>
              <p className="text-amber-400 font-bold text-sm">{SAMPLE_FINDING.severity}</p>
            </div>
            <div className="bg-bg-card p-4 rounded border border-border-color space-y-1">
            ...
            <div className="bg-bg-card p-4 rounded border border-border-color space-y-1">
              ...
              <p className="text-text-primary font-bold text-sm">REMEDIATION READY</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="bg-bg-card p-4 rounded border border-border-color text-text-primary text-sm leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono text-xs">
              <div className="bg-bg-surface-2 p-4 rounded border border-border-color space-y-2">
                <span className="text-cyan-accent font-bold">01 / INITIATE REQUEST</span>
                <p className="text-text-secondary text-[11px] font-mono break-all">
                  {SAMPLE_FINDING.evidence.step1}
                </p>
              </div>

              <div className="bg-bg-surface-2 p-4 rounded border border-border-color space-y-2">
                <span className="text-amber-400 font-bold">02 / BOUNDARY CHECK</span>
              ...
              <div className="bg-bg-surface-2 p-4 rounded border border-border-color space-y-2">
                <span className="text-red-400 font-bold">03 / EXPOSED RESPONSE</span>
                <p className="text-text-secondary text-[11px] font-mono">
          ...
          {/* Fix Recommendation */}
          <div className="bg-bg-surface-2 p-5 rounded border border-cyan-accent/40 space-y-2">
